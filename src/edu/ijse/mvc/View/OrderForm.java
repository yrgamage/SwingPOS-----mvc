...
private void searchCustomer() {
        String custId = jTextField3.getText();
        try {
    ...
    private void searchItem() {
        ...
        try {
            ...
            if(itemDto != null){
                jLabel9.setText(itemDto.getItemCode() + " | " + itemDto.getItemDescription() + " | " + itemDto.getPackSize() + " | " + itemDto.getQoh() + " | " + itemDto.getUnitPrice());
